...
export function Dashboard() {
  ...
  return (
    <div className="dashboard-container">
      ...
      >
        <div>
          <h1 style={{ color: "#1a1a2e", margin: "5px 4px", fontSize: "17px" }}>
            Hello, {userData.name}!
          </h1>
          <p style={{ color: "#7b7f9e", margin: "5px 4px", fontSize: "14px" }}>
            Agency {userData.agency} | Account {userData.account}-
      ...
      <div className="balance-card">
        <span style={{ opacity: 0.8, fontSize: "14px", fontWeight: "500" }}>
          Available Balance
        </span>
        <div
          style={{
        ...
        >
          ...
          >
            {showBalance
              ? `R$ ${walletData.balance.toLocaleString("en-US", { minimumFractionDigits: 2 })}`
              : "R$ •••••"}
          </h2>
          <button
      ...
      <div className="actions-grid">
        <button className="dashboard-action-btn" onClick={handleDeposit}>
          <div className="icon-box">
            <img src={depositImage} alt="Deposit" />
          </div>
          <span>Deposit</span>
        </button>
        ...
        <button className="dashboard-action-btn" onClick={handleWithdraw}>
          <div className="icon-box">
            <img src={withdrawImage} alt="Withdraw" />
          </div>
          <span>Withdraw</span>
        </button>
        <button className="dashboard-action-btn" onClick={handleStatement}>
          <div className="icon-box">
            <img src={statementImage} alt="Statement" />
          </div>
          <span>Statement</span>
        </button>
        <button
          className="dashboard-action-btn investment-highlight"
          onClick={handleInvestments}
        >
          <div className="icon-box">
            <img src={investingImage} alt="Investing" />
          </div>
          <span>Invest</span>
        </button>
        <button className="dashboard-action-btn" onClick={handleAnalisys}>
          <div className="icon-box">
            <img src={analisysImage} alt="Analysis" />
          </div>
          <span>Analysis</span>
        </button>
        <button
        ...
        >
          <div className="icon-box" style={{ padding: "4px" }}>
            ↪
          </div>
          <span>Exit</span>
        </button>
