...
export function Analisys() {
  ...
  const dataValores = analisysData
    ? [
        {
          name: "Deposits",
          value: analisysData.totalAmountDeposit || 0,
          color: COLORS_MAP.deposit,
        },
        {
          name: "Received",
          value: analisysData.totalAmountTransferReceived || 0,
          color: COLORS_MAP.received,
        },
        {
          name: "Sent",
          value: analisysData.totalAmountTransferSent || 0,
          color: COLORS_MAP.sent,
        },
        {
          name: "Withdraws",
          value: analisysData.totalAmountWithdraw || 0,
          color: COLORS_MAP.withdraw,
        },
        {
          name: "Investments",
          value: analisysData.totalAmountInvestment || 0,
          color: COLORS_MAP.investment,
        },
        {
  ...
  const dataQuantidades = analisysData
    ? [
        {
          name: "Deposits",
          value: analisysData.countDeposit || 0,
          color: COLORS_MAP.deposit,
        },
        {
          name: "Received",
          value: analisysData.countTransferReceived || 0,
          color: COLORS_MAP.received,
        },
        {
          name: "Sent",
          value: analisysData.countTransferSent || 0,
          color: COLORS_MAP.sent,
        },
        {
          name: "Withdraws",
          value: analisysData.countWithdraw || 0,
          color: COLORS_MAP.withdraw,
        },
        {
          name: "Investments",
          value: analisysData.countInvestment || 0,
          color: COLORS_MAP.investment,
        },
        {
          name: "Investments Sales",
  ...
  const totalTransactions = dataQuantidades.reduce(
  ...
  return (
    <div className="analisys-screen">
        ...
        <section className="chart-section">
          <div className="chart-header-inline">
            ...
            <div className="total-badge">
              Total flow: R${" "}
              {totalCashFlow.toLocaleString("pt-BR", {
      ...
      <button
        className="analisys-back-button"
